...
public class Jungle {
    ...
    public void place(ArrayList<PseudoAnimal>[] animals){
        for(int k=0 ; k<r ; k++)
            for(int t=0 ; t<s ; t++){
                PseudoAnimal animal = animals[k].get(t) ;
    ...
    public boolean doMovement(PseudoAnimal animal,Cell targetCell){
    ...
    static int calculateI(PseudoAnimal animal,int n ,int r){
        int temp = n/r ;
    ...
    static int calculateJ(PseudoAnimal animal , int m ,int s){
        int temp = m/s ;
